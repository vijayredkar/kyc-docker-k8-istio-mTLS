	...
	public KycResponse processKyc(KycRequest kycReq, String type) throws KycAggregateException  
	{
	    ...
	    */
		...
		{	
		    ...
		    {
		    	//crdChkBasicIstioMtlsUrl = istioBaseMtlsUrl + istioGatewayCreditCheckBasicMtlsPort + creditCheckBasicUri;
		    	/*
		    	crdChkBasicIstioMtlsUrl = istioBaseCredChkBasicMtlsUrl + istioGatewayCreditCheckBasicMtlsPort + creditCheckBasicUri;
